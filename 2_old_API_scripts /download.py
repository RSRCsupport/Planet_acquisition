...
""" script intially provided by planet to download bulk data
this code enables bulk data to be downloaded using a list of scenes 
which is not yet possible with the new API"""
